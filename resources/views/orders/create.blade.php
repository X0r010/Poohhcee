    ...
    <div class="bg-white border border-zinc-200/80 rounded-xl p-5 shadow-2xs">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
            <div>
                ...
                <select id="collection-select" required class="w-full rounded-lg border border-zinc-200 py-2 pl-3 pr-8 text-xs focus:outline-none focus:border-zinc-900 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
            ...
            <div>
                ...
                <select name="design_id" id="design-select" required disabled
                        class="w-full rounded-lg border border-zinc-200 py-2 pl-3 pr-8 text-xs focus:outline-none focus:border-zinc-900 disabled:bg-zinc-50 disabled:text-zinc-400 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
                    <option value="">Select collection first...</option>
                </select>
            </div>
            <div>
                <label class="block text-xs font-medium text-zinc-700 mb-1.5">Shirt Type</label>
                <select name="shirt_type_id" id="shirt-type-select" class="w-full rounded-lg border border-zinc-200 py-2 pl-3 pr-8 text-xs focus:outline-none focus:border-zinc-900 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
            ...
            <div>
                ...
                <select name="size" id="size-select" required class="w-full rounded-lg border border-zinc-200 py-2 pl-3 pr-8 text-xs focus:outline-none focus:border-zinc-900 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
            ...
            <div>
                ...
                <select name="color" id="color-input" required class="w-full rounded-lg border border-zinc-200 py-2 pl-3 pr-8 text-xs focus:outline-none focus:border-zinc-900 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
        ...
        <div class="grid sm:grid-cols-2 gap-3">
            <div id="shirt-status-panel" class="rounded-lg bg-zinc-50 border border-zinc-200 p-3.5">
            ...
            <div id="film-status-panel" class="rounded-lg bg-zinc-50 border border-zinc-200 p-3.5">
        ...
        <div id="stock-use-gate" class="hidden mt-4">
            ...
            <select id="stock-use-select" 
                    class="w-full rounded-lg border border-zinc-300 bg-white py-2 pl-3 pr-8 text-xs font-medium text-zinc-900 shadow-xs focus:border-zinc-900 focus:outline-none focus:ring-1 focus:ring-zinc-900 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
    ...
    <div class="bg-white border border-zinc-200/80 rounded-xl p-5 shadow-2xs">
        ...
        <div class="grid sm:grid-cols-4 gap-4 mb-4">
            ...
            <div>
                ...
                <select name="payment_status" id="payment-status" class="w-full rounded-lg border border-zinc-200 py-2 pl-3 pr-8 text-xs focus:outline-none focus:border-zinc-900 cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2214%22%20height%3D%2214%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23374151%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22m6%209%206%206%206-6%22%2F%3E%3C%2Fsvg%3E')] bg-[length:14px_14px] bg-[right_0.75rem_center] bg-no-repeat">
        ...
        <div id="partial-amount-wrap" class="hidden mb-4 sm:w-1/4">
        ...
        <div class="mt-4">
            ...
            <textarea name="notes" rows="3" placeholder="Any special notes..."
                      class="w-full rounded-lg border border-zinc-200 px-3 py-2 text-xs focus:outline-none focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900"></textarea>
        </div>
    </div>
...
<script>
    ...
    async function checkShirt() {
        ...
        if (!size || !color) {
            panel.className = 'rounded-lg bg-zinc-50 border border-zinc-200 p-3.5';
        ...
        if (shirtTypeId) {
            ...
            params.set('type', shirtTypeName || shirtTypeId); // Send both ID and Name to cover all controller variations
        }
        ...
        try {
            ...
            panel.className = 'rounded-lg bg-rose-50 border border-rose-200 p-3.5';
    ...
    function renderShirtStatus(shirt, panel, panelText) {
        ...
        panel.className = `rounded-lg border p-3.5 ${(colorMap[shirt.class] || colorMap.warning).join(' ')}`;
    ...
    async function checkFilm() {
        ...
        try {
            ...
            if (data.film) {
                ...
                panel.className = `rounded-lg border p-3.5 ${(colorMap[data.film.class] || colorMap.error).join(' ')}`;
                panelText.className = 'text-xs font-medium';
    ...
    function updateStockGate() {
        ...
        // Check if pre-printed stock exists AND has a valid primary key ID
    ...
    function handleStockSelectChange() {
        ...
        if (val === 'use_printed') {
            // Verify ID exists before setting field value
    ...
    // Ensure printed_shirt_id is cleared if user submits without selecting "use_printed"
